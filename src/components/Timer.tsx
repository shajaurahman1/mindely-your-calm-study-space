  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <span
            className={`inline-block px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ease-out ${
              isBreak
      ...
      {showBreakToggle && !isRunning && (
        ...
        >
          <button
            ...
            className={`px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-150 ease-out ${
              !isBreak 
      ...
      <div className="relative w-56 h-56 mx-auto mb-8">
        ...
        >
          ...
          <span className={`text-sm mt-2 transition-all duration-200 ease-out ${
      ...
      <div className="flex items-center justify-center gap-4 mb-6">
        ...
        >
          <Button
            ...
            className="w-12 h-12 rounded-full bg-muted hover:bg-muted/80 transition-all duration-150 ease-out"
          >
        ...
        >
          <Button
            ...
            className={`w-16 h-16 rounded-full text-primary-foreground shadow-lg transition-all duration-200 ease-out ${
              isBreak 
      ...
      <AnimatePresence mode="wait">
        <motion.p
          ...
          exit={{ opacity: 0, y: -6 }}
          transition={{ duration: 0.2, ease: "easeOut" }}
          className={`text-center text-sm transition-all duration-200 ease-out ${
