    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden px-6">
      ...
      >
        ...
        <motion.button
          ...
          className="px-12 py-5 bg-primary text-primary-foreground rounded-full text-lg font-semibold shadow-lg hover:shadow-2xl transition-all duration-200 ease-out animate-glow-pulse"
          style={{
